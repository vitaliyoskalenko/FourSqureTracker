    ...
    extends DetectCheckInSvc
{
    ...
    public static DetectCheckInSvc_.IntentBuilder_ intent(Context context) {
        return new DetectCheckInSvc_.IntentBuilder_(context);
    }
    ...
    public static class IntentBuilder_ {
        ...
        public IntentBuilder_(Context context) {
            context_ = context;
            intent_ = new Intent(context, DetectCheckInSvc_.class);
        }
        ...
        public DetectCheckInSvc_.IntentBuilder_ flags(int flags) {
